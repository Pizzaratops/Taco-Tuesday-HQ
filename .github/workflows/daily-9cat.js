...
function todayYYYYMMDD() {
  // WICHTIG: Nicht die UTC-Kalenderdatum nehmen. Summer-League-Spiele (v.a.
  // Las Vegas) werden nach US-Pazifikzeit angesetzt/datiert, und unsere
  // GitHub-Action-Läufe passieren früh morgens UTC (z.B. 04:07/06:07 UTC),
  // was in Pazifikzeit noch der VORABEND ist. Mit der UTC-Kalenderdatum
  // wurde deshalb systematisch "morgen" abgefragt — Spiele, die in Pacific-
  // Zeit noch gar nicht stattgefunden haben. Fix: Pacific-Kalenderdatum
  // verwenden, wie ESPN es für Summer-League-Spiele selbst tut.
